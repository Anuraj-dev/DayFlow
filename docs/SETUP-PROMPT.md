...
1. Clone the repo if it is not already the current workspace (`git clone https://github.com/Anuraj-dev/DayFlow.git`). Check out `main` and pull. Do not fork unless GitHub access fails.
...
- Do not implement product features in this pass. Do not merge unrelated PRs.
